    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="text-muted-foreground">{t('legal.management.accessDeniedDescription')}</p>
        </CardContent>
      </Card>
    );
  }
    ...
    return (
      <Card>
        <CardContent className="py-12 text-center">
          ...
          <p className="text-muted-foreground">{t('legal.management.failedToLoadDescription')}</p>
        </CardContent>
      </Card>
    );
  }
    ...
    <div className="space-y-6">
                    ...
                    {documents.length === 0 && (
                      <tr>
                        <td className="py-8 text-center text-muted-foreground" colSpan={8}>
                          {t('legal.management.noDocumentsYet')}
                        </td>
                      </tr>
                    )}
                  </tbody>
      ...
      <Dialog open={isCreateDialogOpen} onOpenChange={setIsCreateDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{t('legal.management.createDialog.title')}</DialogTitle>
            <DialogDescription>{t('legal.management.createDialog.description')}</DialogDescription>
          </DialogHeader>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                ...
                >
                  ...
                  <SelectContent>
                    <SelectItem value="en">{t('legal.management.languageOptions.en')}</SelectItem>
                    <SelectItem value="fr">{t('legal.management.languageOptions.fr')}</SelectItem>
                  </SelectContent>
                </Select>
              </div>
              <div>
          ...
          <DialogFooter>
            ...
            >
              {createMutation.isPending
                ? t('legal.management.createDialog.creating')
                : t('legal.management.createDialog.create')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent className="max-w-3xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle>{t('legal.management.editDialog.title')}</DialogTitle>
            <DialogDescription>{t('legal.management.editDialog.description')}</DialogDescription>
          </DialogHeader>
          <div className="space-y-4">
            <div>
          ...
          <DialogFooter>
            ...
            >
              {updateMutation.isPending
                ? t('legal.management.editDialog.updating')
                : t('legal.management.editDialog.update')}
            </Button>
          </DialogFooter>
        </DialogContent>
      </Dialog>
      ...
      <ConfirmationDialog
        ...
        title={t('legal.management.deleteDialog.title')}
        description={t('legal.management.deleteDialog.description', {
          title: selectedDoc?.title || '',
        })}
        confirmText={t('legal.management.deleteDialog.delete')}
