      ...
      <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="max-w-3xl mx-auto text-center space-y-5 md:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center pt-4">
            <Button
              size="lg"
              className="text-lg px-12 h-14 text-primary-foreground bg-primary hover:bg-primary/90 shadow-lg hover:shadow-xl transition-all duration-200 dark:bg-[#361d22] dark:text-white dark:border-[#ff4538] dark:hover:bg-[#4a252c] dark:border"
              asChild
            >
              <Link href="/register">
