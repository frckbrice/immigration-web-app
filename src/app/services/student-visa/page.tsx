        ...
        >
          <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div className="text-center mb-12">
              ...
              >
                <GraduationCap className="h-12 w-12" style={{ color: '#ff4538' }} />
              </div>
              <h1
              ...
              >
                <span suppressHydrationWarning>
                  {t('landing.services.student') || 'Student Visa'}
                </span>
              </h1>
              <p
              ...
              >
                <span suppressHydrationWarning>
                  {t('landing.services.studentDesc') ||
                    'Pursue your education dreams with our student visa assistance'}
                </span>
              </p>
            </div>
